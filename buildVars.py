...
addon_info = AddonInfo(
	...
	addon_name="backgroundContentTracker",
	...
	addon_url="https://github.com/4sensegaming/background-content-tracker",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/4sensegaming/background-content-tracker",
...
pythonSources: list[str] = ["addon/globalPlugins/backgroundContentTracker/*.py"]
